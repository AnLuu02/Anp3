...
document.getElementById('close_playlist').addEventListener('click',e=>{
...
function Main() {
    ...
    // add music library
    document.querySelectorAll('.add_library ion-icon').forEach(item=>{
        item.addEventListener('click',e=>{
            if(e.target === e. currentTarget){
                if(e.target.closest('ul.render')){
                    e.target.closest('ul.render').classList.add('active');
                }
    ...
    document.querySelector('#upload').addEventListener('click',e=>{
        e.preventDefault();
        if(e.target === e.currentTarget){
            document.querySelector('.form_upload_music').classList.toggle('active');
        }
    })
    document.querySelector('.form_upload_music').addEventListener('click',()=>{
        document.querySelector('.form_upload_music').classList.remove('active');
